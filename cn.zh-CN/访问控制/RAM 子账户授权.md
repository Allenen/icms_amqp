...
关于授权相关的操作和用户组授权的概念，请参见[为RAM用户授权](../../../../../cn.zh-CN/用户管理/为RAM用户授权.md#)。
...
关于如何创建自定义策略的具体步骤，请参见[创建自定义策略](../../../../../cn.zh-CN/权限策略管理/自定义策略/创建自定义策略.md#)。

在创建自定义策略时，如需了解 RAM 权限策略语言的基本结构和语法，请参见[权限策略语法和结构](../../../../../cn.zh-CN/权限策略管理/权限策略语言/权限策略语法和结构.md#)。
